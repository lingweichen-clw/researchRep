...
from stanchor.diagnostics.counterfactual import diagnose_counterfactual_checkpoint
from stanchor.utils import save_json


def main() -> None:
    parser = argparse.ArgumentParser(description="Validation-only counterfactual upper-bound diagnosis.")
    ...
    result = diagnose_counterfactual_checkpoint(
    ...
    print(f"counterfactual output: {output}")
